  ...
  <div className="card">
    ...
    <div className="card-content">
      <div className="content is-centered">
        <p className="title is-4 no-padding example__title">{project.title}</p>
      </div>

      <div className="content">
        <p className="example__subtitle">{project.description}</p>
      </div>
      <div className="content">
        <p className="example__price">${project.subtitle}</p>
      </div>
      <div className="content">
        <a href={project.repo}>GitHub Repo</a>
        <a href={project.demo}>Demo App</a>
